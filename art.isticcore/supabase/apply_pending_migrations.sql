-- ============================================================
-- COMPILED PENDING MIGRATIONS for project hkrcyaqktpsebtpipjfz
-- Run this ONCE from the Supabase Dashboard → SQL Editor.
-- 1) Order workflow: confirmed -> preparing -> ready_for_dispatch -> handed_over
--    handed_over is TERMINAL (no refund stage).
-- 2) user_sessions table (DEPRECATED — keep only if you already applied
--    commit 9462bad; safe to skip otherwise)
-- ============================================================
-- ============================================================
...
--    Handover is terminal: handed_over has NO further transitions (no refund).
