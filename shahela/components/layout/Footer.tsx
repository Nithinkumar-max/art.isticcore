        ...
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-on-surface-variant">
              ...
              <li><Link href="/collections/sunflower" className="focus-ring hover:text-primary">Floral bouquets</Link></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-on-surface-variant">
              ...
              <li><Link href="/login" className="focus-ring hover:text-primary">OTP login / register</Link></li>
              <li><Link href="/admin" className="focus-ring text-xs underline hover:text-primary">Admin portal</Link></li>
            </ul>
          </div>
        </div>
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-surface-dim pt-7 text-xs text-on-surface-variant sm:flex-row">
          <p>© {new Date().getFullYear()} Art.isticcore Studio. All rights reserved.</p>
